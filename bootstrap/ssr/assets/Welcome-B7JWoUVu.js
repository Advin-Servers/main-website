    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title${_scopeId}>Cloud VPS &amp; Dedicated Servers</title><meta head-key="description" name="description" content="Get KVM Cloud VPS servers and dedicated servers featuring the world&#39;s fastest processors at an affordable price."${_scopeId}><meta head-key="keywords" name="keywords" content="Advin Servers, affordable hosting solutions, reliable hosting services, secure web hosting, cloud hosting, dedicated servers, epyc servers, epyc genoa, epyc genoa servers, epyc genoa 9654, cloud vps, kvm vps, amd epyc vps, ryzen vps, ryzen vds, 7950x vds, 7950x3d vds"${_scopeId}>`);
          } else {
            return [
              createVNode("title", null, "Cloud VPS & Dedicated Servers"),
              createVNode("meta", {
                "head-key": "description",
                name: "description",
                content: "Get KVM Cloud VPS servers and dedicated servers featuring the world's fastest processors at an affordable price."
              }),
              createVNode("meta", {
                "head-key": "keywords",
                name: "keywords",
            ...
            return [
              ...
              createVNode("div", { class: "relative max-w-7xl mx-auto px-3 pt-10" }, [
                createVNode("div", { class: "overflow-hidden sm:rounded-lg" }, [
                  ...
                  createVNode("div", { class: "relative max-w-7xl mx-auto pt-20" }, [
                    createVNode("div", { class: "overflow-hidden sm:rounded-lg" }, [
                ...
                createVNode("div", { class: "bg-white py-16 sm:py-24" }, [
                  createVNode("div", { class: "mx-auto max-w-7xl pt-20" }, [

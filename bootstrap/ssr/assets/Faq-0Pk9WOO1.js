...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mx-auto max-w-7xl py-24 sm:py-32 mt-5" }, _attrs))}><div class="mx-auto max-w-7xl divide-y divide-gray-900/10"><h2 class="text-2xl font-bold leading-10 tracking-tight text-gray-900">Frequently asked questions</h2><dl class="mt-5 space-y-6 divide-y divide-gray-900/10"><!--[-->`);

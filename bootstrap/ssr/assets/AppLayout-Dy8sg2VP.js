...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></ul></div></div></div></div><div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24"><p class="text-xs leading-5 text-gray-400">© 2020 Your Company, Inc. All rights reserved.</p></div></div></footer>`);
    };
  }
};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li></ul></div><div class="hidden md:flex md:order-2 space-x-3 md:space-x-4 rtl:space-x-reverse"><a href="https://clients.advinservers.com/login" class="rounded-md text-white border border-solid hover:border-gray-400 focus:ring-4 border-gray-200 focus:outline-none focus:ring-blue-300 font-medium text-sm px-4 py-2 text-center text-black">Client Area</a><a${ssrRenderAttr("href", _ctx.route("cloud"))} class="rounded-md text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-4 py-2 text-center">Order Cloud</a></div></div><div class="${ssrRenderClass([{ "block": isOpen.value, "hidden": !isOpen.value }, "md:hidden"])}" id="mobile-menu"><div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        href: _ctx.route("home"),
        active: _ctx.route().current("home")
      }, {

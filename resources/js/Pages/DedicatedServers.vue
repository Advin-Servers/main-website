                    ...
                    <div class="col-span-6 sm:col-span-4">
                        <div class="grid lg:grid-cols-3">
                            <div v-for="(group, index) in productGroups" :key="group.id" class="relative w-72 lg:w-96" >
                                ...
                                <label :for="'group_' + index" class=" rounded-md shadow peer-checked:border-solid peer-checked:border-gray-500 flex cursor-pointer select-none border p-4 pr-20" for="radio_1">
                                    <div class="ml-2">
